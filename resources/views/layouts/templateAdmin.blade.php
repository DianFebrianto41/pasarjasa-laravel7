...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">PasarJasa.id</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('/layanan')}}">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Layanan</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('/profesi')}}">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Profesi</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('/penyediajasa')}}">
                    <i class="fas fa-fw fa-cog"></i>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Pasarjasa.id 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="{{ URL::asset('admin/s/sb-admin-2.min.js') }}j"></script>
